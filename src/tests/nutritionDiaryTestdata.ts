...
export const TEST_DIARY_ENTRY_1 = new DiaryEntry({
    ...
    weightUnitId: null,
    amount: 120,
    datetime: parseLocalDate('2023-07-01'),
...
export const TEST_DIARY_ENTRY_4 = new DiaryEntry({
    ...
    weightUnitId: null,
    amount: 20,
    datetime: parseLocalDate('2023-07-02'),
    ingredient: TEST_INGREDIENT_3
});
...
export const TEST_DIARY_ENTRY_5 = new DiaryEntry({
    ...
    weightUnitId: null,
    amount: 20,
    datetime: parseLocalDate('2023-07-03'),
    ingredient: TEST_INGREDIENT_3
});
...
export const TEST_DIARY_ENTRY_6 = new DiaryEntry({
    ...
    weightUnitId: null,
    amount: 50,
    datetime: parseLocalDate('2023-07-04'),
    ingredient: TEST_INGREDIENT_3
});
...
export const TEST_DIARY_ENTRY_7 = new DiaryEntry({
    ...
    weightUnitId: null,
    amount: 50,
    datetime: parseLocalDate('2023-07-05'),
    ingredient: TEST_INGREDIENT_3
});
...
export const TEST_DIARY_ENTRY_8 = new DiaryEntry({
    ...
    weightUnitId: null,
    amount: 100,
    datetime: parseLocalDate('2023-07-06'),
    ingredient: TEST_INGREDIENT_3
});
...
export const TEST_DIARY_ENTRY_9 = new DiaryEntry({
    ...
    weightUnitId: null,
    amount: 80,
    datetime: parseLocalDate('2023-07-07'),
    ingredient: TEST_INGREDIENT_3
});
...
export const TEST_DIARY_ENTRY_10 = new DiaryEntry({
    ...
    weightUnitId: null,
    amount: 80,
    datetime: parseLocalDate('2023-07-08'),
    ingredient: TEST_INGREDIENT_3
});
...
export const TEST_DIARY_ENTRY_11 = new DiaryEntry({
    ...
    weightUnitId: null,
    amount: 500,
    datetime: parseLocalDate('2023-06-01'),
    ingredient: TEST_INGREDIENT_3
});
...
export const TEST_DIARY_ENTRY_12 = new DiaryEntry({
    ...
    weightUnitId: null,
    amount: 500,
    datetime: parseLocalDate('2023-06-15'),
...
export const TEST_DIARY_ENTRY_13 = new DiaryEntry({
    ...
    weightUnitId: null,
    amount: 500,
    datetime: parseLocalDate('2023-06-20'),
    ingredient: TEST_INGREDIENT_4
});
...
export const TEST_DIARY_ENTRY_14 = new DiaryEntry({
    ...
    weightUnitId: null,
    amount: 20,
    datetime: parseLocalDate('2023-08-20'),
    ingredient: TEST_INGREDIENT_4
});
